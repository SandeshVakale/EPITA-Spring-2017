 ...
 var weatherArray = [Weather]()
  ...
  @IBAction func unwindToWeatherList(sender: UIStoryboardSegue){
    ...
    override func viewDidLoad() {
      ...
      weatherArray.append(Weather(city: "Mumbai", temperature: 37, picture: UIImage(named:"Mumbai"))!)
      weatherArray.append(Weather(city: "Paris", temperature: 10, picture: UIImage(named:"Paris"))!)
      weatherArray.append(Weather(city: "Pune", temperature: 32, picture:
          UIImage(named:"Pune"))!)
      weatherArray.append(Weather(city: "Tokyo", temperature: 28, picture: UIImage(named:"Tokyo"))!)
      weatherArray.append(Weather(city: "Nasik", temperature: 17, picture: UIImage(named:"Nasik"))!)
    }
